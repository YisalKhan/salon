<?php
/* Load Class. */
$fxupdater_updater = new ULTIMATE_VC_ADDONS_Updater();

/**
 * Updater Class
**/
class ULTIMATE_VC_ADDONS_Updater{
	...
	public function __construct() {
		...
		/* Updater Config */
		$this->config = array(
			'server'  => 'http://download.visualmodo.com/updates/',
			'type'    => 'plugin',
			'id'      => 'Ultimate_VC_Addons/Ultimate_VC_Addons.php',
			'api'     => '1.0.0',
			'post'    => array(),
		);
